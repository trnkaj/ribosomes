...
plot(data$tot~data$gem,xlab="gemcitabine (μM)", ylab="TNTs per 10 000 cells", cex.lab = 1.4, pch = 19, col = rgb(0, 0, 0, 0.5), main = "Dose-dependent increase in TNTs (89 % credible interval)")
