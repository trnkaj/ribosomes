...
# FITC gate threshold based on negative population (siRNA treated cells)
...
write.csv(a, "./figure5de+supplfigs5de/exp19_20_22_one_gate.csv", row.names = FALSE)
